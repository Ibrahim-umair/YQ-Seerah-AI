...
def main():
    ...
    parser.add_argument("--retriever", choices=["both", "vector", "bm25"], default="both")
    ...
    want_vector = args.retriever in ("both", "vector")
    want_bm25 = args.retriever in ("both", "bm25")
