...
PILOT_DIR = LOCAL_DIR.parent / "pilot_evaluation"
TRANSCRIPTS_PATH = REPO_ROOT / "data" / "seerah_transcripts.jsonl"
CHUNKS_PATH = PILOT_DIR / "recursive_eval_set_results.json"
MANUAL_QA_DIR = LOCAL_DIR / "manual_qa"
OUTPUT_PATH = PILOT_DIR / "eval_questions.json"
